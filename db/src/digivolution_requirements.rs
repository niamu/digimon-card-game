...
const DIGIVOLVE_TEMPLATES: [Template; 19] = [
    ...
    Template {
        path: "resources/images/templates/digivolution-requirements/v3_2_1.png",
        version: 3,
        requirements_count: 2,
    },
    Template {
        path: "resources/images/templates/digivolution-requirements/v3_2_2.png",
        version: 3,
        requirements_count: 2,
    },
    Template {
        path: "resources/images/templates/digivolution-requirements/v3_2_3.png",
        version: 3,
        requirements_count: 2,
    },
    Template {
        path: "resources/images/templates/digivolution-requirements/v3_2_4.png",
        version: 3,
        requirements_count: 2,
    },
    Template {
        path: "resources/images/templates/digivolution-requirements/v3_2_5.png",
        version: 3,
        requirements_count: 2,
    },
    Template {
        path: "resources/images/templates/digivolution-requirements/v3_2_6.png",
        version: 3,
        requirements_count: 2,
    },
    Template {
        path: "resources/images/templates/digivolution-requirements/v3_2_7.png",
        version: 3,
        requirements_count: 2,
    },
    Template {
        path: "resources/images/templates/digivolution-requirements/v3_2_8.png",
        version: 3,
        requirements_count: 2,
    },
    Template {
        path: "resources/images/templates/digivolution-requirements/v3_2_9.png",
        version: 3,
        requirements_count: 2,
    },
    Template {
        path: "resources/images/templates/digivolution-requirements/v3_2_10.png",
        version: 3,
        requirements_count: 2,
    },
    Template {
    ...
    for color in colors {
        let coords = Coords {
            x: color.coords.x + base_coords.x + {
                if digivolve_template.version == 3 {
                    4
                } else {
                    0
                }
